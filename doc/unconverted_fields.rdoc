...
Specifies the boolean determining whether unconverted field values are to be available.

  CSV::DEFAULT_OPTIONS[:unconverted_fields] # => nil
...
+unconverted_fields+, that returns the unconverted field values:
  ...
  csv = CSV.parse(data, converters: :integer, unconverted_fields: true)
  csv # => [["foo", 0], ["bar", 1], ["baz", 2]]
